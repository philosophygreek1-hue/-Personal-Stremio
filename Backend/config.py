...
class Telegram:
    ...
    # Personal files addon — no TMDB needed
    TMDB_API = getenv("TMDB_API", "")       # kept for compat but unused
    DEFAULT_FOLDER = getenv("DEFAULT_FOLDER", "General")  # default folder for files
